...
export default function Home() {
  return (
    <div className="Main">
      ...
      <header>
        <h2 class="title">Welcome to online prescription order </h2>
      </header>
      <br></br>
      <br></br>
      <br></br>
      ...
      <section class="texto">
        ...
        <div className="container mt-5">
          <h3 className="mt-5 text-center">
            ...
            <b> Please Upload Your Precription And Enter Your Order Details</b>
            <br></br>
            ...
            <div class="area51">
              ...
              <br></br>
              <img
                src="https://i.postimg.cc/90BKWhrn/pngwing-com-21.png"
                style={{
                  width: "90px",
                  height: "50px",
                }}
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <img
                src="https://i.postimg.cc/RZGSgkdG/pngwing-com-20.png"
                style={{
                  width: "60px",
                  height: "60px",
                }}
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <img
                src="https://i.postimg.cc/X7QmmnMZ/pngwing-com-9.png"
                style={{
                  width: "50px",
                  height: "50px",
                }}
          ...
          >
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img
                  src="https://i.postimg.cc/ZqJ2fGdw/Tosca-Blue-Minimalist-Medical-Store-Etsy-Shop-Cover.png"
                  class="d-block w-100"
                  alt="..."
                ></img>
              </div>
              <div class="carousel-item">
                <img
                  src="https://i.postimg.cc/kMpW5WMs/Tosca-Blue-Minimalist-Medical-Store-Etsy-Shop-Cover-1.png"
                  class="d-block w-100"
                  alt="..."
                ></img>
              </div>
              <div class="carousel-item">
                <img
                  src="https://i.postimg.cc/fR4XcZ90/Tosca-Blue-Minimalist-Medical-Store-Etsy-Shop-Cover-2.png"
                  class="d-block w-100"
                  alt="..."
                ></img>
              </div>
          ...
          <div>
            ...
            >
              <div class="wrap">
                <button class="btn1">Get start</button>
                <br></br>
              </div>
            </a>
          </div>
          ...
          <div class="centered">
            <div class="blog-cards">
              ...
              <section class="content">
                ...
                <p>
                  Order online and have your prescription medication delivered
          ...
          <div class="centered">
            <div class="blog-cards">
              ...
              <section class="content">
                ...
                <p>
                  Weathera Pharmacy Limited a 100% subsidiary of Sunshine
                  Healthcare is one of the 1st branded retail Pharmaceutical
                  Chains in Sri Lanka that has entered the market with a view of
                  creating a difference in the retail pharmaceutical trade.....
                </p>
                <a class="more" href="#">
                  Read more...
                </a>
